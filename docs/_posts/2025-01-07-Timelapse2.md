---
layout: post
title: "Make Timelapse Videos with Your Axis Camera"
...
> **A newer version is available.** [Timelapse 3](/acap/2026/08/08/Timelapse3.html) records **H.264 in MP4** instead of MJPEG AVI — far smaller files, no 2 GB recording limit, and playback directly in the browser. It migrates existing Timelapse 2 recordings in place.
>
> Timelapse 3 requires an **aarch64** camera on **AXIS OS 12 or 13**. If your camera is **armv7hf**, stay on Timelapse 2 — this page still applies and the app keeps working.
