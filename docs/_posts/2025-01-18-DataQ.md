---
layout: post
title: "DataQ: Axis Device Data Integration"
date: 2025-01-18 00:00:00
categories: [ACAP]
excerpt: "Working with events, object motion detections, trackers and paths"
image: /assets/object_detection.png
---
...
DataQ Radar is a variation of DataQ designed for Axis radar devices. It provides the same MQTT-based data integration but tailored to radar-specific data output.

**Supported devices**

| Device | Architecture |
|--------|-------------|
| Axis D2110 Radar | armv7hf |
| Axis D2210 Radar | aarch64 |

The DataQ Radar `.eap` files for both architectures are included in the download ZIP file below.
...
### [Download pre-compile ACAP](https://www.dropbox.com/scl/fi/03gzooytc2cakmrl7kh5r/DataQ.zip?rlkey=3zx1mhin5obw6aaqz0sv5a142&dl=1) 
